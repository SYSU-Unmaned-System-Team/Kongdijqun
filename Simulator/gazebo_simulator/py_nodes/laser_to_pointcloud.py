...
class Laser2PC():
    def __init__(self):
        ...
        self.pcPub = rospy.Publisher("/uav1/prometheus/sensor/pcl2", pc2, queue_size=1)
        self.laserSub = rospy.Subscriber("/uav1/prometheus/sensor/2Dlidar_scan", LaserScan, self.laserCallback) 
